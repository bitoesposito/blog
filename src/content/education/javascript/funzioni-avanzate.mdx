...
greetHello('Vito'); // "Hello, Vito"
// 'Hello' è preconfigurato, 'Vito' viene passato alla chiamata
```
...
greet.call(null, 'Hello', 'Vito');  // esegue immediatamente
greet.apply(null, ['Hello', 'Vito']); // stessa cosa, argomenti in array
```
