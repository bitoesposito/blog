...
let fullName = firstName + ' ' + lastName; // "Max Schwarz"
```
...
// Risultato: "Ciao, mi chiamo Max e ho 30 anni."
```
...
Le chiavi (come `name`, `age`) identificano le proprietà dell'oggetto, mentre i valori (come `'Max'`, `30`) sono i dati memorizzati.
