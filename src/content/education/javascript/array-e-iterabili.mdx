...
```javascript
const nameFragments = ['Vito', 'Esposito'];
const fullName = nameFragments.join(' '); // 'Vito Esposito'
const withComma = nameFragments.join(); // 'Vito,Esposito' (virgola di default)
```
...
```javascript
const nameData = ['Vito', 'Esposito', 'Mr', 30];
