...
`this` si riferisce all'oggetto a cui appartiene il metodo. Questo concetto non sarà molto importante in questo caso perché non creeremo molti metodi, ma è importante conoscerlo.
...
**Nota**: le classi non vengono utilizzate frequentemente in questo caso, ma è importante conoscerle. In React moderno, si preferisce spesso utilizzare funzioni invece di classi per i componenti.
