...
Tutto è nato dalla difficoltà di trovare un orario per andare in palestra con un mio amico. Tra impegni di lavoro, appuntamenti e routine quotidiane, coordinare gli orari richiedeva continui messaggi e verifiche manuali. Serviva uno strumento semplice per vedere quando entrambi eravamo liberi, senza dover confrontare calendari.

DuoSync nasce da questa esigenza concreta, ma è stato progettato per essere flessibile: funziona per coppie che condividono la vita quotidiana, gruppi di amici che vogliono organizzare attività insieme, o piccoli team che devono coordinare impegni. Supporta fino a 10 utenti, permettendo di visualizzare la disponibilità condivisa e ricevere notifiche quando qualcuno aggiorna i propri impegni.
...
Quando un utente conferma i propri impegni tramite il pulsante "Conferma", viene inviata una notifica push agli altri utenti (se hanno abilitato le notifiche), avvisandoli che l'utente specifico ha confermato i propri impegni.
