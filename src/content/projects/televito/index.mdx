...
<div class="flex w-full justify-center">
  <Button variant="outline" size="lg" className="w-full justify-between">
    <Link href="https://tv.vitoesposito.it" target="_blank">Vai all'applicazione</Link>
