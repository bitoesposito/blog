...
// Icone non presenti in lucide (marchi registrati rimossi dalla v1)
...
type IconName = LucideName | keyof typeof customIcons

// "arrow-right" / "github" -> "ArrowRight" / "Github"
function toPascalCase(name: string): LucideName {
  return name
    .split(/[-_]/)
